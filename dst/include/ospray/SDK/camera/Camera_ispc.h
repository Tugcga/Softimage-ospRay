//
// C:/Users/visuser/gitlab-runner/builds/oGM4Jr8r/0/renderkit/ospray/build_release/ospray/camera/Camera_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void Camera_set(void * _self, const float nearClip, const struct vec2f &imageStart, const struct vec2f &imageEnd, const struct box1f &shutter, const bool motionBlur, struct RTCGeometryTy * geom);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
